...
import {sunroofCategories} from '../../data/StretchCeilingdata';

const SunroofCeiling = () => {
  return (
     <>
      <Helmet>
        <title>Sunroof Ceiling - NOOH Living Elevated</title>
      </Helmet>
      ...
      <div className="min-h-screen bg-luxury-black pt-24">
        ...
        <section className="section-padding">
          <div className="container-custom mx-auto text-center">
            ...
            >
              Explore our premium virtual sunroof ceiling systems designed for
          ...
          <section className="pb-20 bg-luxury-black">
                  <div className="max-w-6xl mx-auto px-5 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center gap-y-8">
                      {sunroofCategories.map((item, index) => (
                        <motion.div
                          key={index}
                          initial={{ opacity: 0, y: 30 }}
